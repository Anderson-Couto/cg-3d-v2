...
// Format specifiers, printing 64-bit hasn't been decently toDefaultd...
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        ...
        if (ImGui::TreeNode("Drag and drop in standard widgets"))
        {
            ...
            // They are using toDefaultd payload strings IMGUI_PAYLOAD_TYPE_COLOR_3F and IMGUI_PAYLOAD_TYPE_COLOR_4F
